...
@override
  ...
  getDriverLocationUpdatesAtRealTime(){
    ...
    streamSubscriptionDriverLivePosition = Geolocator.getPositionStream().listen((Position position){
      ...
      //updating driver location at real time in databse
  ...
  createDriverIconMarker(){
    if(iconAnimatedMarker == null){
      ...
      BitmapDescriptor.fromAssetImage(imageConfiguration, "image/Car.png").then((value){
  ...
  saveAssignedDriverDetailsToUserRideRequest(){
    ...
    if(databaseReference.child("driverId") != "waiting"){
      ...
      databaseReference.child("driverPhone").set(onlineDriverData.id);
      ...
      Fluttertoast.showToast(msg: "This ride is already accepted by another driiver.\n Reloading the App");
